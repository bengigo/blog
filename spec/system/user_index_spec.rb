...
RSpec.describe 'visit home page', type: :system do
  before do
    @user1 = User.create(name: 'Test User1',
                         photo: 'https://images.unsplash.com/photo-1492681290082-e932832941e6?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2942&q=80',
                         bio: 'Test bio 1.',
                         posts_counter: 0)
    @user2 = User.create(name: 'Test User2',
                         photo: 'https://images.unsplash.com/photo-1494959764136-6be9eb3c261e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80',
                         bio: 'Test bio 2.',
                         posts_counter: 0)

    @post1 = Post.create(author: @user1, title: 'Auctor neque vitae',
                         text: 'Pharetra pharetra massa massa ultricies mi quis hendrerit dolor magna eget est lorem ipsum dolor sit amet consectetur adipiscing elit pellentesque habitant morbi tristique senectus',
                         comments_counter: 0,
                         likes_counter: 0)
    @post2 = Post.create(author: @user2, title: 'Consectetur lorem',
                         text: 'Congue eu consequat ac felis donec et odio pellentesque diam volutpat commodo sed egestas egestas fringilla phasellus',
                         comments_counter: 0, likes_counter: 0)
    @post3 = Post.create(author: @user1, title: 'nulla facilisi',
                         text: 'metus vulputate eu scelerisque felis imperdiet proinr libero',
                         comments_counter: 0, likes_counter: 0)
    ...
    @post5 = Post.create(author: @user1, title: 'a diam',
                         text: 'dui vivamus arcu felis bibendum ut tristique et egestas us eget tesque massa placerat duis ultricies lacus sed',
                         comments_counter: 0, likes_counter: 0)
    @post6 = Post.create(author: @user2, title: 'morbi non',
                         text: 'ac felis donec et odio pellentesque diam volutpat commodo sedretium vulputate sapien nec sagittis aliquam malesuada',
                         comments_counter: 0, likes_counter: 0)
